...
?>
<div class="operations-page" data-page-type="revenue" data-chart-data='<?= json_encode($data['chart_data']) ?>'>
    <div class="operations-card">
        <div class="operations-card-body">
            <div class="dashboard-section-header border-revenue">
                        ...
                        <h2 class="dashboard-section-title">收入</h2>
                    ...
                    <div class="dashboard-grid-4-cols">
                        <div class="dashboard-stat-card" data-type="revenue">
                            <div class="dashboard-stat-card-header">
                                <div class="dashboard-stat-icon bg-revenue">
                                    <?= render_icon('currency', ['width' => '24', 'height' => '24']) ?>
                                </div>
                                <div class="dashboard-stat-trend neutral">总计</div>
                            </div>
                            <div class="dashboard-stat-content">
                                <div class="dashboard-stat-label">总收入</div>
                                <div class="dashboard-stat-value">¥<?= number_format($data['total'], 2) ?></div>
                                <div class="dashboard-stat-sub">累计收入金额</div>
                            </div>
                            <div class="dashboard-stat-details">
                                <div class="dashboard-stat-detail-item">
                                    <div class="dashboard-stat-detail-value">¥<?= number_format($data['today'], 2) ?></div>
                                    <div class="dashboard-stat-detail-label">今日</div>
                                </div>
                                <div class="dashboard-stat-detail-item">
                                    <div class="dashboard-stat-detail-value">¥<?= number_format($data['yesterday'], 2) ?></div>
                        ...
                        <div class="dashboard-stat-card" data-type="revenue">
                            ...
                            <div class="dashboard-stat-content">
                                ...
                                <div class="dashboard-stat-value">¥<?= number_format($data['today'], 2) ?></div>
                        ...
                        <div class="dashboard-stat-card" data-type="revenue">
                            ...
                            <div class="dashboard-stat-content">
                                <div class="dashboard-stat-label">昨日收入</div>
                                <div class="dashboard-stat-value">¥<?= number_format($data['yesterday'], 2) ?></div>
                        ...
                        <div class="dashboard-stat-card" data-type="revenue">
                            <div class="dashboard-stat-card-header">
                                <div class="dashboard-stat-icon bg-revenue">
                                    <?= render_icon('percent', ['width' => '24', 'height' => '24']) ?>
                                </div>
                                <div class="dashboard-stat-trend 
                                    <?php if ($data['growth_rate'] > 0): ?>
                                        up
                    ...
                    <div class="dashboard-chart-container">
                        <div class="dashboard-chart-title">收入趋势</div>
                    ...
                    <div class="operations-data-table">
                        <div class="operations-table-header">
                            <h3>详细数据</h3>
                            <button class="operations-export-btn" data-export-type="revenue">导出数据</button>
                        </div>
                            ...
                            <table class="operations-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-revenue">¥<?= number_format((float)($item['value'] ?? 0), 2) ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
