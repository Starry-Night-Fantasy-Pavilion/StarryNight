...
?>
<div class="operations-page" data-page-type="new_anime" data-chart-data='<?= json_encode($data['chart_data']) ?>'>
    <div class="operations-card">
        <div class="operations-card-body">
            <div class="dashboard-section-header border-anime">
                        <div class="dashboard-section-indicator bg-anime"></div>
                        <h2 class="dashboard-section-title">新增动漫</h2>
                    ...
                    <div class="dashboard-grid-4-cols">
                        <div class="dashboard-stat-card border-anime">
                            <div class="dashboard-stat-label">总动漫数</div>
                            <div class="dashboard-stat-value text-anime"><?= number_format($data['total']) ?></div>
                            <div class="dashboard-stat-sub">累计动漫数量</div>
                        </div>
                        <div class="dashboard-stat-card border-anime">
                            <div class="dashboard-stat-label">今日新增</div>
                            <div class="dashboard-stat-value text-anime"><?= number_format($data['today']) ?></div>
                        ...
                        <div class="dashboard-stat-card border-anime">
                            ...
                            <div class="dashboard-stat-value text-anime"><?= number_format($data['yesterday']) ?></div>
                            <div class="dashboard-stat-sub">对比基准</div>
                        </div>
                        <div class="dashboard-stat-card border-anime">
                            <div class="dashboard-stat-label">增长率</div>
                            <div class="dashboard-stat-value text-anime">
                                <?php if ($data['growth_rate'] > 0): ?>
                    ...
                    <div class="dashboard-chart-container">
                        <div class="dashboard-chart-title">新增动漫趋势</div>
                        <div class="dashboard-chart-wrapper-lg">
                            <canvas id="newAnimeChart" class="dashboard-chart"></canvas>
                        </div>
                    </div>
                    ...
                    <div class="operations-data-table">
                        <div class="operations-table-header">
                            <h3>详细数据</h3>
                            <button class="operations-export-btn" data-export-type="newAnime">导出数据</button>
                        </div>
                            ...
                            <table class="operations-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-anime"><?= number_format((int)($item['value'] ?? 0)) ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
