...
$days = $days ?? 30;
$group = $group ?? 'day';
$data = $data ?? ['today' => 0, 'yesterday' => 0, 'growth_rate' => 0, 'chart_data' => []];
?>
<div class="operations-page" data-page-type="dau" data-chart-data='<?= json_encode($data['chart_data']) ?>'>
    <div class="operations-card">
        <div class="operations-card-body">
            <div class="dashboard-section-header border-dau">
                        <div class="dashboard-section-indicator bg-dau"></div>
                        <h2 class="dashboard-section-title">日活用户 (DAU)</h2>
                    ...
                    <div class="dashboard-grid-4-cols">
                        <div class="dashboard-stat-card" data-type="dau">
                            <div class="dashboard-stat-card-header">
                                <div class="dashboard-stat-icon bg-dau">
                                    <?= render_icon('activity', ['width' => '24', 'height' => '24']) ?>
                                </div>
                                <div class="dashboard-stat-trend neutral">
                        ...
                        <div class="dashboard-stat-card" data-type="dau">
                            ...
                            <div class="dashboard-stat-content">
                                <div class="dashboard-stat-label">昨日活跃</div>
                    ...
                    <div class="dashboard-chart-container">
                        <div class="dashboard-chart-title">日活用户趋势</div>
                        <div class="dashboard-chart-wrapper-lg">
                            <canvas id="dauChart" class="dashboard-chart"></canvas>
                        </div>
                    </div>
                    ...
                    <div class="operations-data-table">
                        <div class="operations-table-header">
                            <h3>详细数据</h3>
                            <button class="operations-export-btn" data-export-type="dau">导出数据</button>
                        </div>
                            ...
                            <table class="operations-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-dau"><?= number_format((int)($item['value'] ?? 0)) ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
