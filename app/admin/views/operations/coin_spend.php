...
?>
<div class="operations-page" data-page-type="coin_spend" data-chart-data='<?= json_encode($data['chart_data']) ?>'>
        ...
        <div class="operations-card-body">
            <div class="dashboard-section-header border-coins">
                    ...
                    <div class="dashboard-grid-4-cols">
                        <div class="dashboard-stat-card" data-type="coin">
                            <div class="dashboard-stat-card-header">
                                <div class="dashboard-stat-icon bg-coin">
                                    <?= render_icon('coins', ['width' => '24', 'height' => '24']) ?>
                                </div>
                                <div class="dashboard-stat-trend neutral">总计</div>
                            </div>
                            <div class="dashboard-stat-content">
                                <div class="dashboard-stat-label">总消耗</div>
                                <div class="dashboard-stat-value"><?= number_format($data['total']) ?></div>
                                <div class="dashboard-stat-sub">累计消耗星夜币</div>
                            </div>
                        ...
                        <div class="dashboard-stat-card" data-type="coin">
                            ...
                            <div class="dashboard-stat-content">
                                <div class="dashboard-stat-label">今日消耗</div>
                        ...
                        <div class="dashboard-stat-card" data-type="coin">
                            ...
                            <div class="dashboard-stat-content">
                                <div class="dashboard-stat-label">昨日消耗</div>
                    ...
                    <div class="dashboard-chart-container">
                        <div class="dashboard-chart-title">星夜币消耗趋势</div>
                        <div class="dashboard-chart-wrapper-lg">
                            <canvas id="coinSpendChart" class="dashboard-chart"></canvas>
                        </div>
                    </div>
                    ...
                    <div class="operations-data-table">
                        <div class="operations-table-header">
                            <h3>详细数据</h3>
                            <button class="operations-export-btn" data-export-type="coinSpend">导出数据</button>
                        </div>
                            ...
                            <table class="operations-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-coins"><?= number_format((float)($item['value'] ?? 0), 0) ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
